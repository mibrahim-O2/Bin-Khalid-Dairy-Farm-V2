...
import { updateSupplierPayment } from "../../actions";
    ...
    <Dialog open={open} onOpenChange={(next) => { setOpen(next); if (next) setError(null); }}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Owner-only. Changing the amount re-applies it against the supplier&apos;s outstanding
            purchases from scratch, oldest first.
          </DialogDescription>
        </DialogHeader>
