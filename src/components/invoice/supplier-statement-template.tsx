...
const typeLabels: Record<SupplierLedgerTransaction["type"], { en: string; ur: string }> = {
  ...
  purchase_void: { en: "Purchase Void", ur: "خریداری منسوخ" },
  payment: { en: "Payment", ur: "ادائیگی" },
  payment_void: { en: "Payment Void", ur: "ادائیگی منسوخ" },
};

/**
 * A bilingual (English + Urdu) statement for a supplier's ledger over a
 * date range — mirrors BillInvoiceTemplate exactly (same fixed-width,
 * print/share-ready, theme-independent document, same bilingual-labels-
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between text-sm">
        <div>
          <Label en="Supplier" ur="سپلائر" />
          <p className="mt-1 text-base font-semibold">{statement.supplierName}</p>
        </div>
        <div className="text-right">
